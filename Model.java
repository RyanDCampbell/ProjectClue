...
public class Model {
    ...
    private final Card weaponAnswer;
    private final Card locationAnswer;
    private final Card perpetratorAnswer;
    ...
    public void setupCards(ArrayList<Card> cards) {
        ...
        for (int i = 0; i < cards.size(); i++) {
            ...
            if (currPlayer instanceof ComputerPlayer) {
                ...
                cPlayer.addCard(currCard);
            }
            else {
                hPlayer = (HumanPlayer) currPlayer;
                hPlayer.addCard(currCard);
            }
        }
    }
    ...
    public void play() {
        ...
        while (!gameOver) {
            ...
            if (guess.getAccusation()) {
                if (weaponGuess.getValue().equals(weaponAnswer.getValue()) && locationGuess.getValue().equals(locationAnswer.getValue()) && suspectGuess.getValue().equals(perpetratorAnswer.getValue())) {
                    winner = currPlayer;
